...
<?php if($this->backend == true):
	...
	//get the wysiwyg, the front end just has textareas
...
<tr>
	...
	<td>
		...
		class="text_area" size="24" maxlength="12" value="<?php echo $this->configParams['img_quality'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['menu_max_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['menu_max_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		<?php if($this->backend == true): 
			 		echo $editor->display( 'menu_description', '' ,'100%', '150', '60', '5' );
		      endif; ?>
		
		<?php if($this->backend == false): ?>
			<textarea cols="50" rows="2" name="menu_description" id="menu_description"></textarea>
		<?php endif; ?>
...
<?php if($this->backend == true): ?>
	...
	<?php
	//end the category tab
	echo $pane->endPanel(); 
	
	//start the main image tab
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['max_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['max_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['img_container_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['img_container_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<?php if($this->backend == true): ?>
	...
	<?php
	//end the main image tab
	echo $pane->endPanel();

	//start the thumbnails tab
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['thumb_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['thumb_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['thumb_container_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['thumb_container_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['images_per_row']; ?>" /> 
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="24" maxlength="12" value="<?php echo $this->configParams['scroll_speed'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="24" maxlength="12" value="<?php echo $this->configParams['scroll_boundary'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['slideshow_pause'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['photo_des_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['photo_des_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_max_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_max_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['lbox_img_container_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['lbox_img_container_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_thumb_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_thumb_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_thumb_container_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_thumb_container_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="12" maxlength="12" value="<?php echo $this->configParams['lbox_images_per_row']; ?>" /> 
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="24" maxlength="12" value="<?php echo $this->configParams['lbox_scroll_speed'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		class="text_area" size="24" maxlength="12" value="<?php echo $this->configParams['lbox_scroll_boundary'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_slideshow_pause'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_photo_des_width'] ?>" />
	</td>
</tr>
<?php endif; ?>
...
<tr>
	...
	<td>
		...
		size="12" maxlength="12" value="<?php echo $this->configParams['lbox_photo_des_height'] ?>" />
	</td>
</tr>
<?php endif; ?>
</table>
