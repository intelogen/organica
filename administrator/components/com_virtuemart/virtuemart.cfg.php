...
define( 'URL', 'http://maximlife.test.seanetix.com/' );
define( 'SECUREURL', 'http://maximlife.test.seanetix.com/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/jewerly_shop/' );
} else {
define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/jewerly_shop/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/jewerly_shop/' );
...
define('DOWNLOADROOT', '/var/www/maximlife/');
...
define('VM_FEED_MAX_TEXT_LENGTH', '100');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_list','product_name','product_price','product_cdate' );
