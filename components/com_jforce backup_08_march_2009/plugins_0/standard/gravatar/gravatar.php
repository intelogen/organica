...
<!--                    <div class='objectTitle textleft'><a href="/index.php/component/jforce/message/message"><?= JText::_('My Messages');?></a></div>-->
                    <div class='objectTitle textleft'><a href="/index.php?option=com_jforce&c=message&view=message"><?= JText::_('My Messages');?></a></div>
                    <!--
                    ...
                    <div class='objectTitle textleft'><a href="/index.php?option=com_jforce&c=project&status=Not+Started">My Progress</a></div>
                    <!--
