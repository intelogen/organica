...
<div class='tabContainer2'>
    <div>
        ...
        <p style="font-size:1.4em;border:1px solid #DDD;background-color:#EfEfEf">
            <a href="/uploads_jtpl/phase_directions/Phase<?=$this->phase_number;?>_Directions.pdf" title="Download directions for this phase"><img src="/uploads_jtpl/icons/general/download.jpg" align="middle"> Directions for Phase <?=$this->phase_number;?></a>
        </p>
