...
<div class='tabContainer2'>
    <div>
        <p>
            Results... Please click on a body systems title to see how the program can work for you and why.
        </p>
        <p>
            Thank you for completing your surveys. This is the most important part of your health journey... starting. You will be contacted for a review of your results by one of our staff members shortly.
        </p>
        <p>
            <strong>
                Good Luck! 
    ...
    <div>
        <?php
            //mdie($this->all_survey_results);
            foreach($this->all_survey_results as $res){            
                $name = split("_",$res->survey_variable,2);
                echo "<strong>".strtoupper($name[1])."</strong>";
                echo "<div style='clr:both'/>";
                echo $res->survey_value;
                echo "<div style='clr:both'/><br />";
            }
        ?>
    </div>
    
    <form action="<?=JRoute::_("index.php?option=com_jforce&view=project&status=Not Started");?>" method="post">
