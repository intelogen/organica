...
?>
<div class='contentheading'>Coaches</div>
<div class='quickLinks'>
	<a href='<?php echo JRoute::_('index.php?option=com_jforce&c=people&view=company&layout=form'); ?>' class='button'><?php echo JText::_('New Coach'); ?></a>
</div>
