...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
    	<td class="contentheading">
            <img src="/images/icons/inbox_compose.jpg">
            <!--
            <?php echo $this->title;?>
            -->
        </td>
        <td align="right">
            <a href="<?=JRoute::_("index.php?option=com_jforce&view=message"); ?>">Return to Inbox</a> | 
...
<table width='100%' cellpadding='5' cellspacing='0' class='admintable'>
			...
			<tr class="sectiontableentry0">
				<td class='label' width="65">
					...
					<!-- JTPL HACK, 
					client can send message to his/her coach only
					-->
