...
';
  */
?>
 <?php //что бы их увидеть нужн их розкоментить))  ?>
...
<div class="tabContainer2">
    ...
    <input type="submit" name="save_as_new" value="Save as new phase" <?php echo $this->pid >= $cant ? 'disabled="true"' : ''; ?> />
