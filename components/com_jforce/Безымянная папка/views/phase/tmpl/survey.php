...
<form method="post" action="<?=$this->step_action_link;?>" class="form-validate" id="josForm" name="josForm"onSubmit="return myValidate(this);">
...
<div class='tabContainer2'>
            ...
            <td colspan=2>
                <table>
                    <tr>
                        ...
                        <td><input type="text" style="width: 50px;" tabindex="1" id="txtWeight" name="survey[intake][W]" class="inputbox required validate-numeric"/>
                             <strong>lbs</strong>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Body Fat</b></td>
                        <td><input type="text" style="width: 50px;" tabindex="2" id="txtBodyFat" name="survey[intake][F]" class="inputbox required validate-numeric"/>
                             <strong>%</strong></td>
                    </tr>
                    <tr>
                        <td><b>PH Score</b></td>
                        <td><input type="text" style="width: 50px;" tabindex="3" id="txtPHScore" name="survey[intake][PH]" class="inputbox required validate-numeric"/></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <param name="flashvars" value="percent=100"><embed src="http://www.maximlrg.com/maximonline/images/flash/meter.swf" quality="high" wmode="transparent" play="true" loop="true" width="80" height="20" name="fcStructural" scale="None" flashvars="percent=100" menu="True" type="application/x-shockwave-flash" pluginspace="http://www.macromedia.com/go/getflashplayer"></embed></object></noscript>
        ...
        <tr>
            <td colspan="2">
                <strong><?=$this->survey_name;?></strong>
            </td>
        </tr>
        <?php
                ...
                ?>
                    <tr>
                        ...
                        <td bgcolor="#fff9d2" width="23%"><p class="style1">
                                <input type="radio" name="survey[start][<?=$q->variable;?>]" value="Y"/>
                                Yes    <input type="radio" name="survey[start][<?=$q->variable;?>]" value="N" />
                                No</p>
                        </td>
                    </tr>
                <?php
        ...
        <tr>
            ...
            <td bgcolor="#fff9d2" width="23%"><p class="style1">
                    <input type="radio" id="Radio36" name="survey[start][diabetes]" value="Y"/>
                    Yes    <input type="radio" id="Radio49" name="survey[start][diabetes]" value="N" />
                    No</p>
            </td>
        </tr>
        <tr>
            ...
            <td bgcolor="#fff9d2"><p class="style1">
                    ...
                    <input type="radio" id="Radio37" name="survey[start][endochrine]" value="Y"/>

                    Yes    <input type="radio" id="Radio48" name="survey[start][endochrine]" value="N"/>
        ...
        <tr>
            ...
            <td bgcolor="#fff9d2"><p class="style1">
                    ...
                    <input type="radio" id="Radio38" name="survey[start][hypertension]" value="Y"/>

                    Yes    <input type="radio"  id="Radio47" name="survey[start][hypertension]" value="N"/>
        ...
        <tr>
            ...
            <td bgcolor="#fff9d2"><p class="style1">
                    ...
                    <input type="radio" id="Radio39" name="survey[start][committed]" value="Y"/>

                    Yes    <input type="radio" id="Radio46" name="survey[start][commited]" value="N"/>
