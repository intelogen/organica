...
?>
<div class='contentheading'><?php echo JText::_('My Progress'); ?></div>
...
<div class='tabContainer'>
            ...
            <div class='row<?php echo $k; ?>'>
				...
				<div class="listTitle">
					<a href='<?php echo JRoute::_('index.php?option=com_jforce&view=checklist&pid='.$project->id); ?>'><?php echo $project->name; ?></a>
				</div>
                <div class="subheading"><?php echo "<strong>Status : ".$project->status."</strong>"; ?></div>
                <!--
