...
<form action='<?php echo $this->action ?>' method='post' name='adminForm'>
	...
	<div class="mainColumn">
			...
			<label for='name' class='key'><?php echo JText::_('Name'); ?></label>			
					<input type='text' name='name' size='50' class='inputbox' value='<?php echo $this->quote->name;?>' />
			</div>
			<div class='editField'>			
			<label for='description' class='key'><?php echo JText::_('Description'); ?></label>
					<textarea name='description' cols='35' rows='10' class='inputbox'><?php echo $this->quote->description;?></textarea>
			</div>
	</div>
	<div class='secondaryColumn sideBox'>
        ...
        <?php endif; ?>
			...
			<?php echo JHTML::_('calendar', $this->quote->validtill, 'validtill', 'validtill', '%Y-%m-%d', array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'19', 'readonly'=>'readonly')); ?>
			</div>
			<div class='editField2'>
			<label for='publishdate' class='key'><?php echo JText::_('Start Publishing'); ?></label>
			<?php echo JHTML::_('calendar', $this->quote->publishdate, 'publishdate', 'publishdate', '%Y-%m-%d', array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'19', 'readonly'=>'readonly')); ?>
			</div>						
			<div class='editField2'>
			...
			<div class='editField2'>
			<label for='accepted' class='key'><?php echo JText::_('Status'); ?></label>
					<?php echo $this->lists['accepted']; ?>
			</div>

			<div class='editField2'>
			<label for='numinvoices' class='key'><?php echo JText::_('Invoices'); ?></label>
					<input type='text' name='numinvoices' size='5' class='inputbox' value='<?php echo $this->quote->numinvoices;?>' />
			</div>
			<div class='editField2'>
			<label for='interval' class='key'><?php echo JText::_('Interval'); ?></label>
					<input type='text' name='interval' size='5' class='inputbox' value='<?php echo $this->quote->interval;?>' />
			</div>
            <div class='editField'>
					...
					$k = $i%2; ?>
						<div class='row<?php echo $k; ?>' id='service_<?php echo $i;?>'>
							...
							<div class='serviceDescription'>
                                ...
                                <div>
                                	<a href='<?php echo JRoute::_('index.php?option=com_jforce&view=modal&layout=editdescription&tmpl=component&i='.$i); ?>' id="descriptionEditLink_<?php echo $i;?>" class='modal' rel="{handler: 'iframe', size: {x: 460, y: 250}}"><?php echo JText::_('Edit'); ?></a>
                                </div>
                            </div>
        ...
        <div class='totalsArea'>
            <div class='sideBox'>
                <div class='field'>
                    <div class='key'><?php echo JText::_('Subtotal'); ?></div>
                    <span id='subtotal'><?php echo $this->quote->subtotal; ?></span>
                </div>
                <div class='field'>
                    <div class='key'><?php echo JText::_('Discount'); ?></div>
                    <span id='discount'><?php echo $this->quote->discount; ?></span>
                </div>
                <div class='field'>
                    <div class='key'><?php echo JText::_('Tax'); ?></div>
                    <span id='tax'><?php echo $this->quote->tax; ?></span>
                </div>
                <div class='fieldTotal'>
                    <div class='key'><?php echo JText::_('Total'); ?></div>
                    <span id='total'><?php echo $this->quote->total; ?></span>
                </div>
            </div>
        </div>
<input type='hidden' name='total' id='totalHidden' value='<?php echo $this->quote->total; ?>' />
<input type='hidden' name='subtotal' id='subtotalHidden' value='<?php echo $this->quote->subtotal; ?>' />
<input type='hidden' name='tax' id='taxHidden' value='<?php echo $this->quote->tax; ?>' />
<input type='hidden' name='discount' id='discountHidden' value='<?php echo $this->quote->discount; ?>' />
<input type='hidden' name='option' value='com_jforce' />
<input type='hidden' name='model' value='quote' />
<input type='hidden' name='pid' value='<?php echo $this->quote->pid; ?>' />
<input type='hidden' name='ret' value='<?php echo @$_SERVER['HTTP_REFERER']; ?>' />
<input type='hidden' name='id' value='<?php echo $this->quote->id; ?>' />
