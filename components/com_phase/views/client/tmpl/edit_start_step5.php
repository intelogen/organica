...
<form action="index.php?option=com_phase&controller=client&step=5&pid=<?=$pid?>&uid=<?=$uid?>&id=<?=$id?>&tempid=<?=$tempid?>" method="post" name="adminForm" \>
...
<form action="index.php?option=com_phase&controller=client&task=ed_medtrack&id=<?=$id?>&tempid=<?=$tempid?>" method="post" name="adminForm" \>
