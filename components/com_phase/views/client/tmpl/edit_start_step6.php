...
<form action="index.php?option=com_phase&controller=client&step=6&pid=<?=$pid?>&uid=<?=$uid?>&id=<?=$id?>&tempid=<?=$tempid?>" method="post" name="adminForm" \>
...
<form action="index.php?option=com_phase&controller=client&task=ed_diseases&id=<?=$id?>&tempid=<?=$tempid?>" method="post" name="adminForm" \>
