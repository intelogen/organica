...
class UserController extends JController
{
    ...
    {
        require_once(JPATH_LIBRARIES.DS.'recaptcha'.DS.'recaptchalib.php');
        $privatekey = "6Lc1hswSAAAAAAlvUuZiQi_K7xPfudfpqs9uFpPc";
	...
	function register_save()
	{
        ...
        if(!$success) {
            $msg = JText::_('Captcha entered is invalid');
        ...
        // store a session variable to indicate registration process        
        $session = JSession::getInstance('none',array());
        $session->set("is_registration_process","yes");
