...
class UserViewRegister extends JView
{
	function display($tpl = null)
	{
		...
		# HACK ends here  
		$this->assignRef("coaches",$coaches);

        $this->assignRef('recaptcha', $this->getReCaptcha('6Lc1hswSAAAAAN8bTS_WJQrIxv67L4nhltriR8M5'));

		parent::display($tpl);
	}

    function getReCaptcha($public_key)
    {
