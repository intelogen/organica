...
var briaskInstance<?php echo $module->id?> =
	new briaskISS(<?php echo $module->id; ?>,<?php echo $params->get('Sequence', 0)?0:1; ?>,<?php echo $params->get('nextDelay',0); ?>,<?php echo $params->get('transDelay',0); ?>, briaskPics<?php echo $module->id?>);
</script>