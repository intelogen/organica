...
if( $params->def('copy') ) {
    echo '<span style="clear:both;text-align:right;display:block;line-height:10px;width: 100%;font-size:9px;"><a href="http://www.webhack.in.ua" style="color:#ccc;text-decoration:none;" title="Разработка сайтов" target="_blank" >Разработка сайтов Украина</a></span>';
}
?>