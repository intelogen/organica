...
if (!defined('CONTENTROTATOR_JS')) {
	echo '<script type="text/javascript" src="'.JURI::base().'modules/mod_rokfeature/rokfeature-packed.js"></script>' . "\n";
...
<script type="text/javascript">
	window.addEvent('domready', function() {
		var rotator = new RokFeature('news-rotator', {
			delay: <?php echo $params->get('delay'); ?>,
			duration: <?php echo $params->get('duration'); ?>,
            corners: <?php echo $params->get('corners')==0?"true":"false"; ?>,
			...
			fadeIn: <?php echo $params->get('shownopacity') ?>
		});
	});
</script>
<div id="news-rotator">
