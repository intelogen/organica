...
class highslide {
	...
	function load()
	{
		...
		$compress = (int)$params->get('highslide_compressed', 1);
		...
		// load library
		JScriptegrator::JSLoader('highslide', $compress);
	...
	<script type=\"text/javascript\">
		...
		$document->addStyleSheet(JScriptegrator::folder() . '/libraries/highslide/css/cssloader.php?compress=' . $compress . '', 'text/css');
	}
}
