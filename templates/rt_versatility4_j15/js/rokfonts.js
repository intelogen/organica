...
/*
 ...
 jQuery(document).ready( function(){
     console.log((jQuery('html').width() - jQuery('body > .wrapper').width()) / 2, jQuery('.phase-navigation').width());
     jQuery('.phase-navigation').css('left', (jQuery('html').width() - jQuery('body > .wrapper').width()) / 2 - jQuery('.phase-navigation').width());
     jQuery('.phase-navigation').css('top', jQuery('#horiz-menu').height() + jQuery('#header-bar').height() + 43);
     console.log();
     jQuery('.phase-navigation-header').css('left', jQuery('.phase-navigation').css('left').substr(0,3).toInt() + 25 + 'px');
     if (jQuery('html').width() < 768){
         jQuery('.phase-navigation-header').css('left', 'auto');
         jQuery('.phase-navigation').css('left', 'auto');
         jQuery('.phase-navigation').css('top', 'auto');
     }
 });*/
